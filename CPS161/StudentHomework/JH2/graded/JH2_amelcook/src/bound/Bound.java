...
public class Bound {
	...
	public static boolean checkAnswer(int answer, int upper_bound){
	...
	public static void main(String[] args) {
		...
		System.out.println("Starting #: " + starting_number + " Step Size: " + step_size + " Upper Bound: " + upper_bound);
		keyboard.close();
		
	
		
		int answer=starting_number * step_size;
		int spaces = 0;
		while(checkAnswer(answer,upper_bound)){
			starting_number++;
...
public class Bound {
	...
	public static void main(String[] args) {
		...
		(if statement): answer = starting_number * step_size;answer1 <= upper_bound; answer1=starting_number++*step_size
		int answer=starting_number * step_size;answer<=upper_bound;starting_number++)
